...
mod tests {
    ...
    #[test]
    fn test_update_version_kts_simple() {
        let content = r#"
plugins {
    id("java")
}
...
version = "1.0.0"
"#;
        let updated = update_version_kts(content, "1.0.1");
        assert!(updated.contains(r#"version = "1.0.1""#));
    }

    #[test]
    fn test_update_version_kts_with_fallback() {
        let content = r#"
group = "com.devfive"
version = project.findProperty("releaseVersion") ?: "1.0.11"
"#;
        let updated = update_version_kts(content, "1.0.12");
        assert!(
    ...
    #[test]
    fn test_update_version_groovy_assign() {
        let content = r#"
group = 'com.example'
version = '2.0.0'
"#;
        let updated = update_version_groovy(content, "2.0.1");
        assert!(updated.contains("version = '2.0.1'"));
    }

    #[test]
    fn test_update_version_groovy_space() {
        let content = r#"
group 'com.example'
version '3.0.0'
"#;
        let updated = update_version_groovy(content, "3.0.1");
